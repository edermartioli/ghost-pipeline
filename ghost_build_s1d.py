...
"""
    ...
    Description: This routine to build an s1d product out GHOST spectra reduced with DRAGONS
    
    @author: Eder Martioli <emartioli@lna.br>
    Laboratório Nacional de Astrofísica - LNA/MCTI
    
    # for WASP-108 data reduced with dragons, sky subtraction turned off
    python ghost_build_s1d.py --input="/Volumes/Samsung_T5/Science/WASP-108/*_calibrated.fits" -2
    
    # for 18 Sco data reduced with dragons, sky subtraction turned off, no IFU2
    python ghost_build_s1d.py --input="/Volumes/Samsung_T5/Science/18Sco/*_calibrated.fits"

    # for WASP-189 data reduced with dragons, sky subtraction turned off
    python ghost_build_s1d.py --input="/Volumes/Samsung_T5/Science/WASP-189/*_calibrated.fits"
